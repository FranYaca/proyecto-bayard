                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="asistenciatercero.php">Tercer Año</a>
                                    <a class="nav-link" href="asistenciacuarto.php">Cuarto Año</a>
                                    <a class="nav-link" href="asistenciaquinto.php">Quinto Año</a>
                                </nav>
                            </div>
                        ...
                        <?php if ($nombre == "Preceptoria") { ?> 
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                    $consulta = "SELECT * FROM `registro_inasistencia` WHERE `curso`='[2]'";
